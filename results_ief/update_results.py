    ...
    if innerfidelity:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'innerfidelity', 'innerfidelity_ief_neutral_over-ear'),
        ...
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'innerfidelity', 'innerfidelity_ief_neutral_in-ear'),
    ...
    if headphonecom:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'headphonecom', 'headphonecom_ief_neutral_over-ear'),
        ...
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'headphonecom', 'headphonecom_ief_neutral_in-ear'),
    ...
    if oratory1990:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'oratory1990', 'ief_neutral_over-ear'),
        ...
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'oratory1990', 'ief_neutral_in-ear'),
    ...
    if rtings:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'rtings', 'rtings_ief_neutral_over-ear'),
        ...
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'rtings', 'rtings_ief_neutral_in-ear'),
    ...
    if referenceaudioanalyzer:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'referenceaudioanalyzer', 'referenceaudioanalyzer_hdm-x_ief_neutral_over-ear'),
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'referenceaudioanalyzer', 'referenceaudioanalyzer_hdm1_ief_neutral_over-ear'),
        ...
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'referenceaudioanalyzer', 'referenceaudioanalyzer_siec_ief_neutral_in-ear'),
    ...
    if crinacle:
        if onear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'crinacle', 'ears-711_ief_neutral_over-ear'),
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'crinacle', 'gras_43ag-7_ief_neutral_over-ear'),
                compensation=ief_overear,
                **onear_kwargs
            )
        if inear:
            ...
            batch_processing(
                ...
                output_dir=os.path.join(ROOT_DIR, 'results_ief', 'crinacle', 'ief_neutral_in-ear'),
                compensation=ief_inear,
                **inear_kwargs
            )
